...
<body>
  ...
  <section class="about section-padding" id="section_2">
      ...
      <div class="row">
        <div class="col-lg-12 col-12">
          <div class="services-thumb">
            ...
            <p><strong>Technologie:</strong> <?php echo $row["technologie"]; ?></p>
            <p><strong>Semester:</strong> <?php echo $row["semester"]; ?></p>
            <p><strong>annee:</strong> <?php echo $row["annee"]; ?></p>
    ...
    <div class="back-icon-container">
      <a href="indexGET.php" class="back-icon"><i class="bi bi-arrow-return-left"></i>Retour à la page précédente</a>
    </div>
  </section>
