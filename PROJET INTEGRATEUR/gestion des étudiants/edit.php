...
if (isset($_POST["submit"])) {
  ...
  $sql = "UPDATE `etudiant` SET `matricule`='$matricule',`nom`='$nom ',`prenom`='$prenom ',`niveaux`='$niveaux',`semester`='$semester'";
    ...
    <div class="container d-flex justify-content-center">
      <form action="" method="post" style= "width:50vw; min-width:300px #00ff5573;">
        ...
        <div class="mb-3">
          ...
          <input type="tel" class="form-control" name="matricule" value="<?php echo $row['matricule'] ?>">
        </div>
        <div class="col">
            <label class="form-label">niveaux</label>
            <input type="text" class="form-control" name="niveaux" value="<?php echo $row['niveaux'] ?>">
          </div>
        <div class="col">
